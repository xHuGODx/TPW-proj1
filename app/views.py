...
def index(request):
    ...
    # Instantiate the form with GET data and categories for dynamic choices
    form = ProductFilterForm(request.GET or None, categories=categories)

    # Filter products based on form data if the form is valid
    ...
    # Initialize the context with the form and filtered products
    context = {
        'products': products,
        'form': form,
        'user': request.user,  # Include user object
    }

    # If the user is authenticated, get their favorite products
    if request.user.is_authenticated:
        ...
        if request.method == 'POST':
            ...
            if created:
                ...
                favorite.delete()
            return redirect('index')  # Redirect after processing favorites
    else:
